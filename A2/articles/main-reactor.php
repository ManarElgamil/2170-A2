...
<body>
	...
	<main id="pg-main-content">
		<article id="main-article">
			<h2>Main reactor busted: Must get replacement from Tosche station</h2>
			<!-- "Reactor 5&6 Cooling Tower 04" by Timm Suess is licensed under Creative Commons License. To view a copy of this license, visit undefined?ref=openverse&atype=rich 
				...
				Date accessed: 18 Jan 2022
			-->
			<img class="article-featured-img" src="../img/reactor.jpg" alt="Picture of a reactor with trees in the foreground and the reactor in the background. The reactor looks old and seems to be deserted.">
	...
	<footer id="pg-footer">
		<p>&copy; 2022. Tiger News Website.</p>
	</footer>
</body>
</html>